...
class Reporting	{
    ...
    public function getReportRequest($id, $report_type) {
        $service = $this->service;

        $request = new MarketplaceWebService_Model_GetReportRequestListRequest();
        $request->setReportRequestIdList((new MarketplaceWebService_Model_IdList())->setId($id));
        $request->setMerchant($this->marchent_id);
...
//        $a = $this->invokeRequestReport($report_type, 'now', '+3 months');

//        $a['request_id'] = '54762017377';
//        $request = new MarketplaceWebService_Model_GetReportRequestListRequest();
//        $request->setReportRequestIdList((new MarketplaceWebService_Model_IdList())->setId($requestId));
//        $request->setMerchant($this->marchent_id);
//        $report_type_array = new MarketplaceWebService_Model_TypeList();
//        $report_type_array->setType($report_type);
//        $request->setReportTypeList($report_type_array);
        ...
        try {
            ...
            if ($response->isSetGetReportListResult()) {
                ...
                foreach ($reportInfoList as $reportInfo) {
                    ...
                    {
                        $report_info[$i]['available_date']	=	$reportInfo->getAvailableDate();
                        /* echo("                    AvailableDate\n");
